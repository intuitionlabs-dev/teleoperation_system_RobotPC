...
def get_yam_robot(
    ...
    kp = np.array([50, 50, 80, 10, 5, 5]) # original: 80, 80, 80, 40, 10, 10
    kd = np.array([5, 5, 5, 1.5, 1.5, 1.5]) # original: 5, 5, 5, 1.5, 1.5, 1.5
    if with_gripper:
    ...
    get_robot = partial(
        ...
        xml_path=model_path,
        use_gravity_comp=False,  # Disabled for follower arms - they should purely track position commands
        gravity_comp_factor=1.0,  # Not used when gravity_comp is False, but keeping default value
