    ...
    def __init__(self) -> None:
        ...
        if not hasattr(self, "PIPER_PARAM"):
            self.__PIPER_PARAM_ORIGIN = {
                "joint_limit":{
                    "j1": [-2.5179, 2.5179], # original: [-2.6179, 2.6179]
                    "j2": [0.1, 3.04], # original: [0, 3.14]
                    "j3": [-2.867, -0.1], # original: [-2.967, 0]
                    "j4": [-1.645, 1.645], # original: [-1.745, 1.745]
                    "j5": [-1.12, 1.12], # original: [-1.22, 1.22]
                    "j6": [-1.99439, 1.99439], # original: [-2.09439, 2.09439]
                },
                "gripper_range": [0.0, 0.07], # original: [0.0, 0.07]
